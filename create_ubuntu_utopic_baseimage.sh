#!/bin/sh
debootstrap --variant=minbase --arch=amd64 utopic ./rootfs-utopic http://de.archive.ubuntu.com/ubuntu
debootstrap --variant=minbase --arch=amd64 utopic ./rootfs-trusty http://de.archive.ubuntu.com/ubuntu
tar -C ./rootfs-utopic -c . | docker import dspeed/ubuntu-utopic
tar -C ./rootfs-trusty -c . | docker import dspeed/ubuntu-trusty
